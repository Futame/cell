...
REAL icalp(struct State *S, struct State *Sn, REAL ht, struct Cpar *C, struct Is *I)
{
    REAL dss, fss;
    REAL td, tf;
    ...
    I->ICaJuncp   = 0.45 * FjuncCaL * ICaJ * S->dp * S->fp * (1.0 - S->fCaBJunc);
    I->ICaSlp     = 0.45 * FslCaL   * ICaS * S->dp * S->fp * (1.0 - S->fCaBSl);
    ICaP  = I->ICaJuncp + I->ICaSlp;
